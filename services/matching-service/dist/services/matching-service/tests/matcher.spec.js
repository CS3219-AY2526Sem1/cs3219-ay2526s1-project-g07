...
describe('Matcher', () => {
    let matcher;
    let redisClient;
    const cacheKey = matcher_1.Matcher.redisCacheKey;
    beforeAll(async () => {
    ...
    beforeEach(async () => {
        ...
        spyOn(global, 'setInterval').and.callFake(mockSetInterval);
    ...
    describe('enqueue', () => {
        it('should enqueue a user matching request', async () => {
            ...
            const queue = await matcher['queue'];
    ...
    describe('findMatch', () => {
        it('should find a match based on preferences', async () => {
            ...
            const spyFindMatch = spyOn(matcher, 'findMatch').and.callThrough();
    ...
    describe('timedOut', () => {
        ...
        describe('tryTimeOut', () => {
            it('should remove timed out requests from the queue', async () => {
                const tryTimedOutSpy = spyOn(matcher, 'tryTimeOut').and.callThrough();
